  ...
  <div class ="center">
	...
	<form action= "results_modelparameters.php" method="post" >
		...
		<h4> allignment source </h4><br>
		  ...
		  <input type="checkbox" name="selectAll"  id="all" onchange = "checkkall()" value="checked" <?php if(isset($_SESSION['selectAll'])){ echo "checked"; }?>>
		  <label for = "PANDIT"> <h4> PANDIT </h4> </label>
		  <input type="checkbox" name="PANDIT"  id="PANDIT"  value="PANDIT" onchange = "checkkall()" <?php if(isset($_SESSION['PANDIT'])){ echo "checked"; }?>>
		   <label for = "Lanfear"> <h4> Lanfear </h4> </label> 
		  <input type="checkbox" name="Lanfear"  id="Lanfear"  value="Lanfear" onchange = "checkkall()"  <?php if(isset($_SESSION['Lanfear'])){ echo "checked"; }?>>
