<?php
	...
	$_SESSION = array();
		...
		$_SESSION['wildcard_gaps_fraction'] = $wildcard_gaps_fraction;
		
		$parsimony_sites_fraction = $_POST['parsimony_sites_fraction'];
		$_SESSION['parsimony_sites_fraction'] =$parsimony_sites_fraction;

		$distinct_patterns_fraction = $_POST['distinct_patterns_fraction'];
		$_SESSION['distinct_patterns_fraction'] =$distinct_patterns_fraction;
