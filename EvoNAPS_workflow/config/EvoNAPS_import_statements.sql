...
(@ALI_ID, SEQ_INDEX, SEQ_NAME, TAX_ID, TAX_CHECK, FRAC_WILDCARDS_GAPS, CHI2_P_VALUE, CHI2_PASSED, EXCLUDED, @IDENTICAL_TO, FREQ_A, FREQ_C, FREQ_G, FREQ_T, SEQ)
SET
ALI_ID='custom_ali_id',
...
(@ALI_ID, SEQ_INDEX, SEQ_NAME, TAX_ID, TAX_CHECK, FRAC_WILDCARDS_GAPS, CHI2_P_VALUE, CHI2_PASSED, EXCLUDED, @IDENTICAL_TO, 
